...
var style_PGjoin_data_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("q2wHide_BlAfm_pop");
    var labelText = "";
    size = 0;
    ...
    if (value >= 3.531180 && value <= 34.815233) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 34.815233 && value <= 66.099287) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 66.099287 && value <= 97.383341) {
            style = [ new ol.style.Style({
