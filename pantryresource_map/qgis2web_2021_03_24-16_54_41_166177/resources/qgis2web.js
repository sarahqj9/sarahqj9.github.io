...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-8977915.005122, 4492604.140974, -8216371.189336, 4974272.999161], maxZoom: 15, minZoom: 1
    })
});
...
layerSwitcher.showPanel();
    ...
    var searchLayer = new SearchLayer({
      layer: lyr_InstitutionsWithPantriesbyType_2,
      colName: 'Name',
      zoom: 10,
      collapsed: true,
      map: map
...
map.getView().fit([-8977915.005122, 4492604.140974, -8216371.189336, 4974272.999161], map.getSize());
