...
var style_pov_percent2019_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("perc_pov");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 5.600000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 5.600000 && value <= 16.129030) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 16.129030 && value <= 31.027470) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 31.027470 && value <= 52.415460) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 52.415460 && value <= 100.000000) {
            style = [ new ol.style.Style({
